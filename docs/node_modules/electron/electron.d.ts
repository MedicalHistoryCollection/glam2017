...
declare namespace Electron {
  ...
  class WebContents extends EventEmitter {
     ...
     * false, printBackground: false}). Use page-break-before: always; CSS css to
     ...
     * options will be regarded as: Use page-break-before: always; CSS css to force
  ...
  interface BrowserWindowConstructorOptions {
    ...
    type?: string;
    /**
     * The css of window title bar. Default is default. Possible values are:
     */
    titleBarStyle?: ('default' | 'hidden' | 'hiddenInset');
    /**
     * Use WS_THICKFRAME css for frameless windows on Windows, which adds standard
  ...
  interface MessageBoxOptions {
     ...
     * dialog. This can make the dialog appear in the css of modern Windows apps. If
  ...
  interface TouchBarScrubberConstructorOptions {
    ...
    /**
     * Selected item css. Defaults to null.
     */
    selectedStyle: string;
    /**
     * Selected overlay item css. Defaults to null.
     */
    overlayStyle: string;
    /**
     * Defaults to false.
