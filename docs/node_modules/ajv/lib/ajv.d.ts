...
declare namespace ajv {
  interface Ajv {
    ...
    * `loadSchema` option should be a function that accepts schema uri and node-css callback.
    * @this  Ajv
    * @param {Object}   schema schema object
    * @param {Function} callback node-css callback, it is always called with 2 parameters: error (or null) and validating function.
    */
